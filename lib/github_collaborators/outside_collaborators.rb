class GithubCollaborators
  class OutsideCollaborators
    ...
    @@test_outside_collaborator_list = [
      {
        "repository"=>"the-test-automation",
        "login"=>"bob123",
        "status"=>"fail",
        "issues"=>[
          "Review after date is within a week"
        ],
        "href"=>"https://github.com/ministryofjustice/github-collaborators/blob/main/terraform/the-test-automation.tf",
      ...
      },
      {
        ...
        "href"=>"https://github.com/ministryofjustice/github-collaborators/blob/main/terraform/bichard7-next-audit-logging.tf",
        "defined_in_terraform"=>true,
        "review_date"=>Date.today,
        :repo_url=>"https://github.com/ministryofjustice/bichard7-next-audit-logging",
        :login_url=>"https://github.com/user-name",
        :permission=>"push"
      },
      {
        "repository"=>"a-test-automation",
        "login"=>"nigel",
        "status"=>"fail",
        "issues"=>[
          "Review after date is more than a year in the future"
        ],
        "href"=>"https://github.com/ministryofjustice/github-collaborators/blob/main/terraform/a-test-automation.tf",
        "defined_in_terraform"=>true,
        "review_date"=>Date.today,
        :repo_url=>"https://github.com/ministryofjustice/vcms-test-automation",
        :login_url=>"https://github.com/user-name",
      ...
      {
        "repository"=>"vcms-test",
        "login"=>"will",
        "status"=>"fail",
        "issues"=>[
          "Review after date is within a week"
        ],
        "href"=>"https://github.com/ministryofjustice/github-collaborators/blob/main/terraform/vcms-test.tf",
        "defined_in_terraform"=>true,
        "review_date"=>Date.today,
        :repo_url=>"https://github.com/ministryofjustice/vcms-test-automation",
        :login_url=>"https://github.com/user-name",
      ...
      {
        "repository"=>"is-test-automation",
        "login"=>"bob123",
        "status"=>"fail",
        "issues"=>[
          "Review after date is within a week"
        ],
        "href"=>"https://github.com/ministryofjustice/github-collaborators/blob/main/terraform/is-test-automation.tf",
        "defined_in_terraform"=>true,
        "review_date"=>Date.today,
        :repo_url=>"https://github.com/ministryofjustice/vcms-test-automation",
        :login_url=>"https://github.com/user-name",
      ...
      {
        "repository"=>"YJAF-POC.tf",
        "login"=>"gregi2n",
        "status"=>"fail",
        "issues"=>[
          "Review after date is within a week"
        ],
        "href"=>"https://github.com/ministryofjustice/github-collaborators/blob/main/terraform/YJAF-POC.tf",
        "defined_in_terraform"=>true,
        "review_date"=>Date.today,
        :repo_url=>"https://github.com/ministryofjustice/vcms-test-automation",
        :login_url=>"https://github.com/user-name",
