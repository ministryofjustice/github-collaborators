...
If you are not confident working with Terraform, you can raise an issue using this template [questionnare](https://github.com/ministryofjustice/github-collaborators/issues/new?assignees=&labels=&template=access-request.md) to request access for a collaborator, and we will make the changes for you.
...
- Manually run this [GitHub Action](https://github.com/ministryofjustice/github-collaborators/actions/workflows/remove-collaborator.yml) will edit and create the pull request to remove a specific collaborator from a repository:
