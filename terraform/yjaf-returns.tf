  ...
  collaborators = [
    {
      ...
      added_by     = "<gareth.davies@digita345l.justice.gov.uk> on behalf of the YJB"
    ...
    },
    {
      ...
      org          = "NPS (northgate)"
      reason       = "Part of the Northgate supplier team for the YJB YJAF system"
      added_by     = "Greg Whiting <greg.whiting@nordfdfggdfgitthgateps.com> Devops for northgate"
